...
import { Menu, Tag, HelpCircle, FileText, Info, ChevronDown, Building2, Package, BriefcaseBusiness, GraduationCap } from "lucide-react"
import {
  NavigationMenu,
...
export function SiteHeader() {
  ...
  const links = [
    { href: "/explore", label: "Opportunities", icon: BriefcaseBusiness },
    { href: "/learning", label: "Courses", icon: GraduationCap },
          ...
          <div className="hidden md:flex">
            <Button
              ...
              className="bg-lime-400 text-black font-medium rounded-lg px-6 py-2.5
                         ...
                         transition-all"
            >
              <a href="https://wa.link/rc25na" target="_blank" rel="noopener noreferrer">Chat With Us</a>
            </Button>
          </div>
