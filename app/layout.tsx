...
export const metadata: Metadata = {
  title: "SkillSync | Make your next move make sense",
  description:
    "SkillSync connects learners, educators, and industry through a shared skills network for learning, opportunity, and better work.",
  generator: "v0.app",
}
